...
| `:MDView selection` | Toggle mirroring the visual selection (`v`/`V`/`CTRL-V`) into the preview, for presenting | [Preview](docs/FEATURES/PREVIEW.md#visual-selection-mirror) |
